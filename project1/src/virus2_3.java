 ...
 * @author ADM
 */
public class virus2_3 extends javax.swing.JFrame {

    /**
     * Creates new form virus2_3
     */
    public virus2_3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        decripte.setBounds(260, 230, 110, 70);

        buttonGroup1.add(r1);
        r1.setText("jRadioButton4");
        r1.setOpaque(false);
        jPanel1.add(r1);
        r1.setBounds(0, 90, 300, 23);

        buttonGroup1.add(r2);
        r2.setText("jRadioButton3");
        r2.setOpaque(false);
        jPanel1.add(r2);
        r2.setBounds(0, 120, 300, 23);

        buttonGroup1.add(r3);
        r3.setText("jRadioButton2");
        r3.setOpaque(false);
        jPanel1.add(r3);
        r3.setBounds(0, 150, 300, 23);

        buttonGroup1.add(r4);
        r4.setText("jRadioButton1");
        r4.setOpaque(false);
        jPanel1.add(r4);
        r4.setBounds(0, 180, 300, 23);
   ...
   boucleEnonce(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(virus2_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new virus2_3().setVisible(true);
                Chapter L_java= new Chapter("Les Tableaux");
       Lvl lvlIn = new Lvl( 3,2);
            }
        });
    }
