 ...
 * @author ADM
 */
public class virus6_3 extends javax.swing.JFrame {

    /**
     * Creates new form virus6_3
     */
    public virus6_3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        decripte.setBounds(310, 220, 90, 80);

        buttonGroup1.add(r1);
        r1.setText("jRadioButton4");
        r1.setOpaque(false);
        jPanel1.add(r1);
        r1.setBounds(0, 60, 93, 23);

        buttonGroup1.add(r2);
        r2.setText("jRadioButton3");
        r2.setOpaque(false);
        jPanel1.add(r2);
        r2.setBounds(0, 90, 93, 23);

        buttonGroup1.add(r3);
        r3.setText("jRadioButton2");
        r3.setOpaque(false);
        jPanel1.add(r3);
        r3.setBounds(0, 110, 93, 23);

        buttonGroup1.add(r4);
        r4.setText("jRadioButton1");
        r4.setOpaque(false);
        jPanel1.add(r4);
        r4.setBounds(0, 140, 93, 23);
   ...
   boucleEnonce(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(virus6_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
